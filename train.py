...
train_dataset = DataSet(r'D:\code\imagefusion-rfn-nest\images\40_pairs_tno_vot_split\vis', train_trainsform)

train_loader = data.DataLoader(train_dataset, batch_size = 4, shuffle=True, num_workers = 2, drop_last = True)
...
if __name__ == '__main__':
    ...
    optimizerD_vis = optim.Adam(netD_vis.parameters(), lr = 1e-3, betas = (0.5, 0.9))
    optimizerD_ir = optim.Adam(netD_ir.parameters(), lr = 1e-3, betas = (0.5, 0.9))
